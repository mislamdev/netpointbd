      ...
      setTimeout(() => {
        ...
        if (typeof $.fn.appear !== 'undefined') {
          ...
          $('.odometer').appear(function(this: any) {
            const odo = $(this);
            const countNumber = odo.attr('data-count');
            if (countNumber) odo.html(countNumber);
          });
        }
      }, 500);
    }
          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="about-img">
                <img src={getAssetPath('/assets/img/about-net-point-bd-logo.jpg')} alt="Net Point BD logo" width="600" height="370" loading="lazy" />
              </div>
            </div>
            <div className="col-lg-6">
      ...
      <section className="about-us-area ptb-100" id="btrc">
        <div className="container">
          <div className="row align-items-center flex-row-reverse g-5">
            <div className="col-lg-6">
              <div className="about-img">
                <img src={getAssetPath('/assets/img/btrc.jpg')} alt="BTRC Approval" width="600" height="370" loading="lazy" />
              </div>
            </div>
            <div className="col-lg-6">
              ...
              <div className="col-lg-6 col-sm-6">
                <div className="single-counter overly-one">
                  <div className="overly-two">
                    ...
                    <h2><span className="odometer" data-count="400">00</span></h2>
                    <h3>Network Setup</h3>
                  </div>
                </div>
              </div>
              <div className="col-lg-6 col-sm-6">
                <div className="single-counter overly-one">
                  <div className="overly-two">
                    ...
                    <h2><span className="odometer" data-count="1000">00</span></h2>
                    <h3>Happy Client</h3>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-6 col-sm-6">
                <div className="single-counter overly-one">
                  <div className="overly-two">
                    ...
                    <h2><span className="odometer" data-count="100">00</span><span className="target">%</span></h2>
                    <h3>Satisfactions</h3>
                  </div>
                </div>
              </div>
